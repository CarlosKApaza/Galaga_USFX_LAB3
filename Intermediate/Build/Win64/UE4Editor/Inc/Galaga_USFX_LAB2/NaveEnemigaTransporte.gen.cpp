...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_VelocidadXTransporte_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_VelocidadXTransporte;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANaveEnemigaTransporte_Statics::NewProp_VelocidadXTransporte_MetaData[] = {
		{ "Category", "Nave" },
		{ "ModuleRelativePath", "NaveEnemigaTransporte.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANaveEnemigaTransporte_Statics::NewProp_VelocidadXTransporte = { "VelocidadXTransporte", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANaveEnemigaTransporte, VelocidadXTransporte), METADATA_PARAMS(Z_Construct_UClass_ANaveEnemigaTransporte_Statics::NewProp_VelocidadXTransporte_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANaveEnemigaTransporte_Statics::NewProp_VelocidadXTransporte_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANaveEnemigaTransporte_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANaveEnemigaTransporte_Statics::NewProp_VelocidadXTransporte,
	};
	...
	IMPLEMENT_CLASS(ANaveEnemigaTransporte, 4288270061);
